export const companies = [
    ...
    },
    {
        'id': 'owner',
        'title' : 'The Owner App',
        'description' : 'Real Estate Software platform created to help landlors, customers and owners to have the best communication possible. As Software Developer, I was in charge to create react components and create a connection between front-end and backend. It was my first Full Stack project',
        'mission' :'My mission in this project was to create a Full Stack Testing Framework From Scratch and create test scripts to ensure that all currency exchange system is working',
        'url':'',
        'role':'Software Developer'
    },
